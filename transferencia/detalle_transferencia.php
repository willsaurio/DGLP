...
<div class="main2" style="background:whitesmoke;">
	...
	<div class="col-md-12 well">
		...
		<b><p style="font-size: 35px;" class="text-primary">DETALLE DE TRANSFERENCIAS DGLP <i class="fa-solid fa-truck-fast"></i></p></b>
		</div>
		...
		<form class="form-inline" method="POST" action="">
			...
			<a href="detalle_transferencia.php" type="button" style="width: 60px; height: 40px; margin-left:5px;" class="btn btn-success">
...
<form method="post" class="form-inline" action="/DGLP/reportes/planilla.php">
		...
		<div class="table-container" style=" overflow: scroll; max-height: 600px;">	
			<table class="table table-bordered">
				...
				<tbody>
					<?php include'range_transferencia.php'?>	
				</tbody>
			</table>
			</div>
		</div>
