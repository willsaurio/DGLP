...
<?php
$consulta= ("SELECT t1.id, t2.nombre_apellido, t2.cedula, t2.inss, t2.cargo, t2.ubicacion, t1.observacion, t1.entrada from asistencia as t1 
inner join nomina as t2 ON t1.idemp = t2.idEmp 
WHERE t1.fecha_entrada = CURDATE() and t1.salida='00:00:00' AND t1.fecha_salida = '0000-00-00' AND  t2.inss = '$_POST[inss]' LIMIT 1");
...
echo "<form action='salida.php' class='line' method='post' autocomplete='off'>
<br>
...
<form action="RegistroPistolsalida.php" method="post" id="formulario" class="line" enctype="" >
  <br>
...
// Realizar la búsqueda en la nomina para obtener la cédula asociada al INSS
$query = "SELECT t2.cedula from asistencia as t1 
inner join nomina as t2 ON t1.idemp = t2.idEmp 
WHERE t1.fecha_entrada = CURDATE() and t1.salida='00:00:00' AND t1.fecha_salida = '0000-00-00' AND  t2.inss = '$inss' LIMIT 1";
