...
echo "<form action='ALMUERZO.php' class='line' method='post' autocomplete='off'>
<br>
...
<form action="RPistolalmuerzo.php" method="post" id="formulario" class="line" enctype="" >
  <br>
...
<img height="210px" src="data:image/jpg;base64,<?php echo base64_encode($fetch['pic']);?>"/> 
</div>
